...
const ATELIERS = [
  {
    key: "monteverde",
    nome: "Monteverde",
    via: "Via Roberto Alessandri 53",
    cap: "00151 Roma",
    tel: "06 5820 9633",
    maps: "https://www.google.com/maps/search/?api=1&query=Via+Roberto+Alessandri+53+Roma",
  },
  {
    key: "balduina",
    nome: "Balduina",
    via: "Via Romeo Rodriguez Pereira 120",
    cap: "00136 Roma",
    tel: "06 5820 9633",
    maps: "https://www.google.com/maps/search/?api=1&query=Via+Romeo+Rodriguez+Pereira+120+Roma",
  },
  {
    key: "vignaclara",
    nome: "Vigna Clara",
    ...
    cap: "00191 Roma",
    tel: "06 5820 9633",
    maps: "https://www.google.com/maps/search/?api=1&query=Piazza+Carli+10+Roma",
  },
];
  ...
  if (img) {
    return (
      <div
        ...
        style={{ aspectRatio: ratio, background: "var(--lino)" }}
      >
        <img
          src={img.url}
          alt={img.alt}
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10 py-4 flex items-center justify-between gap-6">
        <nav className="hidden md:flex items-center gap-8 flex-1">
          <a
            ...
            className="eyebrow"
            style={{ color: "inherit" }}
            onClick={() => track("cta_click", { source: "nav_sumisura" })}
          >
            Su misura
          </a>
          <a
            ...
            className="eyebrow"
            style={{ color: "inherit" }}
            onClick={() => track("cta_click", { source: "nav_famiglia" })}
          >
            La famiglia
          </a>
          <a
            ...
            className="eyebrow"
            style={{ color: "inherit" }}
            onClick={() => track("cta_click", { source: "nav_atelier" })}
          >
            Atelier
          </a>
        </nav>
        <a
          href="#top"
          className="serif italic text-2xl md:text-3xl leading-none tracking-tight"
          style={{ color: "inherit" }}
        >
          Antichi Telai{" "}
          <span style={{ fontSize: "0.55em", letterSpacing: "0.2em" }} className="not-italic ml-1">
            1894
          </span>
        </a>
        <div className="hidden md:flex items-center gap-5 flex-1 justify-end">
          <a
            ...
            className="eyebrow"
            style={{ color: "inherit" }}
            onClick={() => track("cta_click", { source: "nav_phone" })}
          >
            06 5820 9633
          </a>
          <button
            onClick={() => {
              track("cta_click", { source: "nav_prenota" });
              onBook();
            }}
            className="btn"
        ...
        <button
          onClick={() => {
            track("cta_click", { source: "nav_prenota_mobile" });
            onBook();
          }}
          className="btn md:!hidden"
          style={{ color: "inherit", borderColor: "currentColor", padding: "10px 16px" }}
        >
          Prenota
        </button>
      </div>
    ...
    <section id="top" className="relative w-full h-[100svh] overflow-hidden" style={{ background: "#23201C" }}>
      <div className="absolute inset-0 hero-zoom">
        <Placeholder
          label="hero.jpg"
          ratio="16 / 9"
          className="!h-full !aspect-auto opacity-90"
          imgClassName="object-[85%_center] md:object-center"
        />
      </div>
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(35,32,28,0.35) 0%, rgba(35,32,28,0.15) 40%, rgba(35,32,28,0.85) 100%)",
        }}
      />
      <div className="relative z-10 h-full flex items-end">
        <div className="mx-auto max-w-7xl w-full px-5 md:px-10 pb-16 md:pb-24" style={{ color: "#F4F0E8" }}>
          ...
          <h1 className="serif leading-[0.95]" style={{ fontSize: "clamp(48px, 9vw, 92px)" }}>
            Un abito che{" "}
            <em className="italic" style={{ color: "#E9E2D5" }}>
              ti somiglia
            </em>
            .
          </h1>
          <p className="mt-6 max-w-xl text-base md:text-lg leading-relaxed" style={{ color: "rgba(244,240,232,0.85)" }}>
            Prendiamo le misure, scegliamo la stoffa, cuciamo a mano quello che serve.
            <br />
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            <button
              onClick={() => {
                track("cta_click", { source: "hero_primary" });
                onBook();
              }}
...
function Manifesto() {
  const items = [
    ...
    {
      icon: <IconBottoni />,
      title: "Cuciture interne a mano",
      text: "Le parti che tengono la forma non si vedono. Ci sono.",
    },
      ...
      <div className="mx-auto max-w-5xl px-5 md:px-10 text-center">
        <Rise>
          ...
          <p className="serif italic" style={{ fontSize: "clamp(32px, 5vw, 56px)", lineHeight: 1.15 }}>
            Un capo su misura non è più bello.
            <br /> È più <em>tuo</em>.
          </p>
        </Rise>
          ...
          {items.map((it, i) => (
            <Rise key={i} className="flex flex-col items-center text-center">
              ...
              <p
                ...
                style={{ color: "color-mix(in oklab, var(--inchiostro) 70%, transparent)" }}
              >
                {it.text}
              </p>
            </Rise>
...
function Banda({
  ...
  return (
    <div className="grid md:grid-cols-2 gap-0 items-stretch">
      ...
      <div
        className={`flex items-center px-5 md:px-16 py-16 md:py-24 ${flip ? "md:order-1" : ""}`}
        style={{ background: index % 2 === 0 ? "var(--carta)" : "var(--lino)" }}
      >
        <Rise className="max-w-lg">
          ...
          <p
            ...
            style={{ color: "color-mix(in oklab, var(--inchiostro) 78%, transparent)" }}
          >
            {paragrafo}
          </p>
          <ul className="mt-8">
            {dettagli.map((d, i) => (
              <li
                key={i}
                className="py-3 text-sm flex justify-between items-center"
                style={{ borderBottom: "1px solid var(--border)" }}
              >
                <span>{d}</span>
                <span style={{ color: "var(--ottone)" }} className="eyebrow">
                  0{i + 1}
                </span>
              </li>
            ))}
          ...
          <button
            onClick={() => {
              track("cta_click", { source: `banda_${eyebrow.toLowerCase()}` });
              onBook();
            }}
            className="mt-10 eyebrow link-underline"
  ...
  return (
    <section id="sumisura">
      ...
      <Banda
        ...
        dettagli={[
          "Ordine minimo di due camicie",
          "Numerose combinazioni collo e polso",
          "Ricambi e riparazioni sempre possibili",
        ]}
      ...
      <Banda
        ...
        dettagli={[
          "Percorso guidato dall'inizio",
          "Prova finale a ridosso della data",
          "Custodia e ripassatura incluse",
        ]}
...
function Citazione() {
  return (
    <section className="relative py-32 md:py-48 overflow-hidden" style={{ background: "#23201C" }}>
      ...
      <div
        className="absolute inset-0"
        style={{ background: "linear-gradient(to bottom, rgba(35,32,28,0.85), rgba(35,32,28,0.95))" }}
      />
  ...
  const tappe = [
    {
      ...
      luogo: "Abruzzo",
      testo:
        "Il primo laboratorio della famiglia Di Pietrantonio apre le porte. Si cuce per gli uomini del paese, con le stoffe che arrivano da Napoli e da Biella.",
    },
    {
      anno: "1952",
      luogo: "Roma",
      testo:
        "La sartoria si sposta nella capitale. La bottega di Monteverde diventa il punto di riferimento per professionisti, giornalisti, uomini di teatro.",
    },
    {
      anno: "Oggi",
      luogo: "Savino e Antonio",
      testo:
        "I fratelli Di Pietrantonio conducono la sartoria in tre atelier di Roma. Stesso mestiere di quattro generazioni fa, con clienti che tornano da anni.",
    },
  ];
  return (
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-12 md:gap-16">
          {tappe.map((t, i) => (
            <Rise key={i}>
              <div
                className="serif"
                style={{ color: "var(--bordeaux)", fontSize: "clamp(56px, 7vw, 88px)", lineHeight: 1 }}
              >
                {t.anno}
              </div>
              <p className="eyebrow mt-2" style={{ color: "var(--ottone)" }}>
                {t.luogo}
              </p>
              <p
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
        <Rise className="flex items-end justify-between flex-wrap gap-4 mb-12">
          <div>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(30px, 4vw, 44px)" }}>
              Alcuni gesti, alcuni dettagli.
            </h2>
          </div>
          <a
        ...
        <div className="grid grid-cols-6 gap-3 md:gap-4">
          <div className="col-span-6 md:col-span-4 md:row-span-2">
            <Placeholder label="dettaglio-1.jpg" ratio="4 / 3" className="md:!h-full md:!aspect-auto" />
          </div>
          <div className="col-span-3 md:col-span-2">
            <Placeholder label="ritratto-1.jpg" ratio="3 / 4" />
          </div>
          <div className="col-span-3 md:col-span-2">
            <Placeholder label="dettaglio-3.jpg" ratio="3 / 4" />
          </div>
          <div className="col-span-3 md:col-span-2">
            <VideoLoop src={videoCerimonia.url} ratio="3 / 4" />
          </div>
          <div className="col-span-3 md:col-span-2">
            <Placeholder label="ritratto-2.jpg" ratio="3 / 4" />
          </div>
          <div className="col-span-6 md:col-span-2">
            <VideoLoop src={videoCollezione.url} ratio="3 / 4" />
          </div>
          <div className="col-span-3 md:col-span-3">
            <Placeholder label="ritratto-3.jpg" ratio="3 / 4" />
          </div>
          <div className="col-span-3 md:col-span-3">
            <Placeholder label="camicia.jpg" ratio="3 / 4" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto max-w-3xl px-5 md:px-10 text-center">
        <Rise>
          ...
          <p className="serif" style={{ fontSize: "clamp(22px, 2.5vw, 30px)", lineHeight: 1.5 }}>
            Lavoriamo con <em className="italic">Dormeuil</em>, <em className="italic">Holland &amp; Sherry</em> e i
            migliori lanifici italiani. Le stoffe le vediamo, tocchiamo e scegliamo insieme a te, in atelier.
          </p>
        </Rise>
      </div>
    </section>
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          {recs.map((r, i) => (
            <Rise key={i} className="text-center px-4">
              <div style={{ color: "var(--ottone)", letterSpacing: "0.25em" }} aria-label="5 stelle su 5">
                ★★★★★
              </div>
              <p className="serif italic mt-6" style={{ fontSize: 22, lineHeight: 1.4 }}>
                {r.testo}
              </p>
...
function Prenota({ formRef }: { formRef: React.RefObject<HTMLElement | null> }) {
  ...
  return (
    <section
      ...
      style={{ background: "var(--inchiostro)", color: "#F4F0E8" }}
    >
      <div className="mx-auto max-w-7xl px-5 md:px-10 grid md:grid-cols-2 gap-16 md:gap-24">
        <Rise>
          ...
          <p className="mt-6 text-base leading-relaxed" style={{ color: "rgba(244,240,232,0.75)" }}>
            Ricevuta la richiesta ti chiamiamo entro un giorno lavorativo per fissare l'appuntamento nell'atelier che
            preferisci.
          </p>
          <ul className="mt-10 space-y-4">
            {[
              "Dura circa un'ora.",
              "Non ti impegna a nulla.",
              "Ti diciamo subito i prezzi.",
              "Puoi venire anche solo a vedere i tessuti.",
            ].map((t, i) => (
              <li key={i} className="flex gap-4 items-baseline">
                <span className="eyebrow" style={{ color: "var(--ottone)" }}>
                  0{i + 1}
                </span>
          ...
          <div className="mt-12 pt-8" style={{ borderTop: "1px solid rgba(244,240,232,0.15)" }}>
            <p className="eyebrow mb-4" style={{ color: "rgba(244,240,232,0.6)" }}>
              Se hai fretta
            </p>
            <div className="flex flex-col gap-3">
              <a
                href="tel:+390658209633"
                onClick={() => track("cta_click", { source: "prenota_phone" })}
                className="serif text-2xl link-underline"
              >
                06 5820 9633
              </a>
              <a
                href="https://wa.me/390658209633"
                target="_blank"
                rel="noreferrer"
                onClick={() => track("cta_click", { source: "prenota_whatsapp" })}
                className="eyebrow link-underline"
              >
                WhatsApp
              </a>
              <a
                ...
                onClick={() => track("cta_click", { source: "prenota_email" })}
                className="eyebrow link-underline"
              >
        ...
        <Rise>
          {state === "ok" ? (
            <div className="py-12">
              <p className="eyebrow mb-4" style={{ color: "var(--ottone)" }}>
                Ricevuta
              </p>
              <h3 className="serif" style={{ fontSize: 40, lineHeight: 1.1 }}>
                Ti richiamiamo entro un giorno lavorativo.
              </h3>
              <p className="mt-6" style={{ color: "rgba(244,240,232,0.75)" }}>
                Se preferisci non aspettare:{" "}
                <a className="link-underline" href="tel:+390658209633">
                  06 5820 9633
                </a>
                .
              </p>
            ...
            <form onSubmit={onSubmit} noValidate>
              ...
              <label className="block mt-4">
                ...
                {errors.nome && (
                  <span className="text-xs mt-1 block" style={{ color: "#E9C29B" }}>
                    {errors.nome}
                  </span>
                )}
              </label>
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  {ATELIERS.map((a) => (
                    ...
                    >
                      <div
                        className="eyebrow"
                        style={{ color: selectedAtelier === a.key ? "var(--ottone)" : "rgba(244,240,232,0.6)" }}
                      >
                        {a.nome}
                      </div>
                      <div className="text-xs mt-2" style={{ color: "rgba(244,240,232,0.7)" }}>
                        {a.via}
                      </div>
                    </button>
                  ))}
              ...
              <button
                ...
                style={{ background: "var(--ottone)", borderColor: "var(--ottone)", color: "var(--inchiostro)" }}
              >
              ...
              {state === "error" && (
                <p className="mt-4 text-sm" style={{ color: "#E9C29B" }}>
                  L'invio non è riuscito. Chiamaci direttamente:{" "}
                  <a className="link-underline" href="tel:+390658209633">
                    06 5820 9633
                  </a>
                  .
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
          ...
          {ATELIERS.map((a, i) => (
            <Rise key={a.key} className={`px-6 md:px-10 py-10 md:py-4 ${i > 0 ? "md:border-l" : ""}`}>
              <div style={i > 0 ? { borderColor: "var(--border)" } : {}}>
                <p className="eyebrow" style={{ color: "var(--ottone)" }}>
                  {a.nome}
                </p>
                <p className="serif mt-4 text-2xl leading-snug">
                  {a.via}
                  <br />
                  {a.cap}
                </p>
                <div className="mt-6 flex flex-col gap-2">
                  <a
                    href={`tel:+39${a.tel.replace(/\s/g, "")}`}
                    onClick={() => track("cta_click", { source: `atelier_phone_${a.key}` })}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    onClick={() => track("cta_click", { source: `atelier_maps_${a.key}` })}
                    className="eyebrow link-underline"
                    style={{ color: "var(--bordeaux)" }}
                  >
                    Vedi su mappa →
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8 pt-10" style={{ borderTop: "1px solid var(--border)" }}>
          ...
          <div>
            ...
            <p className="serif text-lg" style={{ color: "color-mix(in oklab, var(--inchiostro) 55%, transparent)" }}>
              Chiuso
            </p>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10 flex flex-col md:flex-row gap-6 md:justify-between md:items-center text-sm">
        <div>
          <p className="serif italic text-xl">
            Antichi Telai <span className="not-italic text-sm tracking-[0.2em]">1894</span>
          </p>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs">
          ...
          <a href="#privacy" className="eyebrow link-underline">
            Privacy
          </a>
          <a href="#cookie" className="eyebrow link-underline">
            Cookie
          </a>
        </div>
      </div>
...
function MobileBar({ onBook, hidden }: { onBook: () => void; hidden: boolean }) {
  ...
  return (
    ...
    >
      <a
        href="tel:+390658209633"
        onClick={() => track("cta_click", { source: "mobilebar_call" })}
        className="btn"
        style={{
      ...
      <button
        onClick={() => {
          track("cta_click", { source: "mobilebar_prenota" });
          onBook();
        }}
        className="btn btn-primary"
        style={{ border: 0, padding: "18px" }}
      >
        Prenota
      </button>
    </div>
...
function Home() {
  ...
  useEffect(() => {
    ...
    if (!el) return;
    const io = new IntersectionObserver((entries) => entries.forEach((e) => setFormVisible(e.isIntersecting)), {
      threshold: 0.2,
    });
    io.observe(el);
    return () => io.disconnect();
